...
@Component({
  selector: 'app-therapist-insight',
  templateUrl: './therapist-insight.page.html',
  styleUrls: ['./therapist-insight.page.scss'],
})
export class TherapistInsightPage implements OnInit {
